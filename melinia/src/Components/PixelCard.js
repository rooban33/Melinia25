...
class Pixel {
    constructor(canvas, context, x, y, color, speed, delay) {
        ...
        this.delay = delay;
        this.counter = 0;
        this.baseMaxSize = 2;  // Base max size
        this.hoverMaxSize = 2; // Increased size on hover
        this.maxSize = this.baseMaxSize; // Default max size
    ...
    setHoverState(isHovered) {
        this.maxSize = isHovered ? this.hoverMaxSize : this.baseMaxSize;
    }
}
